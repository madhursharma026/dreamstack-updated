                    ...
                    <div className="col-md-6 col-xl-3 mt-3">
                        <div className="card w-100 p-3 h-100 text-white" style={{ background: '#31BBAE', border: '0', borderRadius: '0' }}>
                            <div className="card-body text-center">
                                <h3 className="card-title"><b>Blockchain Audit</b></h3>
                                <p className="card-text" style={{ fontSize: '20px' }}>Get the support of high-value transactions for your business with a blockchain security audit</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-xl-3 mt-3">
                        <div className="card w-100 p-3 h-100 text-white" style={{ background: '#31BBAE', border: '0', borderRadius: '0' }}>
                            <div className="card-body text-center">
                                <h3 className="card-title"><b>Blockchain Strategy</b></h3>
                                <p className="card-text" style={{ fontSize: '20px' }}>Analyze the potential of blockchain for your enterprise with real-world applications</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-xl-3 mt-3">
                        <div className="card w-100 p-3 h-100 text-white" style={{ background: '#31BBAE', border: '0', borderRadius: '0' }}>
                            <div className="card-body text-center">
                                <h3 className="card-title"><b>Blockchain Security</b></h3>
                                <p className="card-text" style={{ fontSize: '20px' }}>Eliminate attacks and frauds using cybersecurity frameworks for a blockchain network</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-xl-3 mt-3">
