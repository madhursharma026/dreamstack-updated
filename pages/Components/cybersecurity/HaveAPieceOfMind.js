    ...
    return (
        ...
        <div className={`${styles.ContainerWidth}`}>
            ...
            <div className="row px-lg-5">
                ...
                <div className="col-md-6 mt-lg-5 mt-3">
                    <p className={`${styles.sectionBody} text-danger`}>
                        <img src="https://www.sitelock.com/images/malware-removal-b35999.svg" alt="#ImgNotFound" style={{ width: "60px", height: '60px', paddingTop: '10px' }} />
                ...
                <div className="col-md-6 mt-lg-5 mt-3">
                    <p className={`${styles.sectionBody} text-danger`}>
                        <img src="https://www.sitelock.com/images/Vulnerability-Patching-86972b.svg" alt="#ImgNotFound" style={{ width: "60px", height: '60px', paddingTop: '10px' }} />
                ...
                <div className="col-md-6 mt-lg-5 mt-3">
                    <p className={`${styles.sectionBody} text-danger`}>
                        <img src="https://www.sitelock.com/images/website-backup-b99c43.svg" alt="#ImgNotFound" style={{ width: "60px", height: '60px', paddingTop: '10px' }} />
                ...
                <div className="col-md-6 mt-lg-5 mt-3">
                    <p className={`${styles.sectionBody} text-danger`}>
                        <img src="https://www.sitelock.com/images/Web-Application-Firewall-WAF-bf1382.svg" alt="#ImgNotFound" style={{ width: "60px", height: '60px', paddingTop: '10px' }} />
                ...
                <div className="col-md-6 mt-lg-5 mt-3">
                    <p className={`${styles.sectionBody} text-danger`}>
                        <img src="https://www.sitelock.com/images/Market-Growth-2681dd.svg" alt="#ImgNotFound" style={{ width: "60px", height: '60px', paddingTop: '10px' }} />
