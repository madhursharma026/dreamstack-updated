            ...
            <div className="row px-lg-5 py-5">
                ...
                <div className="col-md-6 pt-3 text-white" style={{ borderLeft: '2px solid white' }}>
                    <div className="px-md-5 px-3">
                        ...
                        <button type="button" class="btn btn-light" style={{ borderRadius: '50px', background: "transparent", color: "white" }}>What We Do →</button><br />
                        <button type="button" class="btn btn-light mt-3" style={{ borderRadius: '50px', background: "transparent", color: "white" }}>The DS Way →</button>
                    </div>
                </div>
            </div>
        </div>
