                    ...
                    <div className={`col ${styles.colNo1}`}>
                        <div class={`card ${styles.cardStyle}`}>
                            <div class="card-body">
                                ...
                                <h1 class="card-title text-primary" style={{ fontSize: '4rem' }}>15+</h1>
                    ...
                    <div className={`col ${styles.colNo2}`}>
                        <div class={`card ${styles.cardStyle}`}>
                            <div class="card-body">
                                ...
                                <h1 class="card-title text-primary" style={{ fontSize: '4rem' }}>10k</h1>
                                <p class="card-text">Customers building with Dreamstack</p>
                            </div>
                        </div>
                    </div>
                    <div className={`col ${styles.colNo3}`}>
                        <div class={`card ${styles.cardStyle}`}>
                            <div class="card-body">
                                ...
                                <h1 class="card-title text-primary" style={{ fontSize: '4rem' }}>99.9%</h1>
                                <p class="card-text">Uptime SLA for Droplets and Volumes block storage</p>
                            </div>
                        </div>
                    </div>
                    <div className={`col ${styles.colNo4}`}>
                        <div class={`card ${styles.cardStyle}`}>
                            <div class="card-body">
                                ...
                                <h1 class="card-title text-primary" style={{ fontSize: '4rem' }}>11K</h1>
