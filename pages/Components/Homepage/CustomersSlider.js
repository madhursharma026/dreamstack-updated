                ...
                <div className={`${styles.imageSlider}`}>
                    <div className={`${styles.imageSliderTrack}`}>
                        <div className={`${styles.slide}`}>
                            <img src={Image1.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image2.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image3.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image4.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image5.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image6.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image7.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
                        <div className={`${styles.slide}`}>
                            <img src={Image1.src} style={{ width: '100%', maxHeight: '65px', objectFit: 'contain' }} />
                        </div>
