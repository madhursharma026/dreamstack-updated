                ...
                <div className="bg-black">
                    <div className={`${styles.ContainerWidth}`}>
                        <div className={`row ${styles.IntroSection}`}>
                            ...
                            <div className='d-md-none d-block text-center py-5' style={{ maxWidth: '300px', margin: 'auto' }}>
                                <img src="https://www.zoho.com/books/images/home-header-image.webp" alt="#ImgNotFound" className='w-100' />
                            </div>
                        </div>
                    </div>
                </div>
